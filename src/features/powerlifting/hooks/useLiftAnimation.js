...
const solveBench = (progress, params = {}, skeletonInfo) => {
  ...
  const elbow = { x: gripX, y: barPosition.y + forearm }
...
const solveDeadlift = (progress, params = {}, skeletonInfo) => {
  ...
  const barPosition = { x: BAR_X, y: ORIGIN_Y - (startClearance + barTravel * p) }
